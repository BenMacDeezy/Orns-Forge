...
kernel orchestration loop, and a routed roster of twenty agents that plan,
...
| **44 skills · 20 agents · 20 commands** | A curated library covering orchestration, frontend/animation, backend/data, and legal/compliance craft |
...
effort. Six are judges — read-only, never edit.
...
twenty-first persona, **örn** — the orchestrator is not backed by an
`agents/*.md` file.
...
- Format contract for every `.forge/` artifact: `docs/conventions.md`.
