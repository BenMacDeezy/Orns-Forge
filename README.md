...
| **61 skills · 25 agents · 26 commands** | A curated library covering orchestration, frontend/animation, mobile (React Native/Expo), backend/data, and legal/compliance craft |
...
| `/forge:monitor` | Open a live side-terminal HUD of all Claude + codex agent activity (agenthud) |
