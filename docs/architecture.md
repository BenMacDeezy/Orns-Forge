...
For a public map of every subsystem and its deeper reference, see the
[Forge systems hub](systems.md).
...
Twenty-six thin slash-command entry points under `commands/*.md`, each invoking
