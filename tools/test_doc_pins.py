...
class TestFgA10802GruntPins(unittest.TestCase):
    ...
    def test_readme_agent_count_is_twenty_three(self):
        ...
        self.assertIn("**44 skills \u00b7 23 agents \u00b7 20 commands**", content)
...
class TestFgA10213RoleLabelPins(unittest.TestCase):
    ...
    def _conventions(self):
        return (REPO_ROOT / "docs" / "conventions.md").read_text(encoding="utf-8")
...
class TestFgA10212TokenCapturePins(unittest.TestCase):
    ...
    def test_telemetry_vocabulary_has_amended_by_pointer(self):
        ...
        c = (REPO_ROOT / "docs/conventions.md").read_text(encoding="utf-8")
        self.assertIn(
