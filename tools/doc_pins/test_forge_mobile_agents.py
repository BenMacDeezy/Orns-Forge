...
class TestForgeMobileAgentsPins(unittest.TestCase):
    ...
    def test_readme_agent_count_is_twenty_five(self):
        ...
        # 25 is the actual commands/*.md inventory count (dropped from 26
        # by the owner-directed startup-banner removal, 2026-07-22).
        self.assertIn("**61 skills · 25 agents · 25 commands**", readme)
