...
class TestOnboardOfferNudgePins(unittest.TestCase):
    ...
    def test_hooks_json_registers_alongside_update_nudge(self):
        ...
        # The separate "startup"-only matcher group (orn-motd.sh) was
        # removed with the startup-banner feature (owner-directed,
        # 2026-07-22), so this group is now the last thing in SessionStart.
