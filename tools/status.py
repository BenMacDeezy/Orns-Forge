...
# preferring `forge@orns-forge`) -- replacing the dead hardcoded
# `forge@forge-local` key the LLM-authored nudge used to compare against.
# Fail-silent throughout: any error, absence, equal versions, or a dev-path
# plugin root with no version segment all resolve to no nudge.
# ---------------------------------------------------------------------------
